...
class UpdateWantedPeopleComponent extends Component {
    constructor(props) {
        super(props)
        ...
        this.updateWantedPeople = this.updateWantedPeople.bind(this);
    }
          ...
          <div className='container'>
              <div className='row'>
                  <div className='card col-md-6 offset-md-3 offset-md-3'>
                      <h3 className='text-center'>Kayıt Bilgilerini Güncelle</h3>
                      <div className='card-body'>
                          <form>
                              ...
                              <button className='btn btn-success' onClick= {this.updateWantedPeople}>Kaydet</button>
...
export default UpdateWantedPeopleComponent;
